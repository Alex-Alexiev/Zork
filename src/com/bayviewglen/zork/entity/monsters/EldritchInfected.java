...
public class EldritchInfected  extends Monster {
	...
	public EldritchInfected() {
		super("EldritchInfected", "Seems humanoid, albeit slightly emancipated, <br>until the mouth opens unnaturally wide, to extend feeding apparatus, <br>consisting of 3 tentacles, lined with sharp teeth", 100, 850);
	}
